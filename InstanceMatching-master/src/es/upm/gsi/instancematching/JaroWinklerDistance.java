...
public class JaroWinklerDistance {
	...
	public JaroWinklerDistance(String s1, String s2) {
		compOne = s1;
		compTwo = s2;
	}
	...
	// ***For testing the algrithm, there are problems
	/*public static void main(String[] args) {
		JaroWinklerDistance jaro = new JaroWinklerDistance("ABC34", "BCD34");
		double sim = jaro.getSimilarity("ABC34", "BCD34");
